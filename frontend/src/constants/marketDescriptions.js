...
export const FINANCIALS_DESCRIPTIONS = {
  'Revenue':      'Total income from operations before any deductions',
  'Gross Profit': 'Revenue minus cost of goods sold',
  'Op. Profit':   'Operating profit (EBIT) — earnings before interest and taxes',
  'Net Profit':   'Bottom-line profit after all expenses, interest and taxes',
  'EPS (₹)':      'Earnings Per Share — net profit divided by total shares outstanding',
  'Total Assets': 'Everything the company owns — current + fixed + investments',
  'Total Debt':   'All borrowings: short-term loans + long-term bonds',
  'Equity':       'Shareholders\' equity — net worth after subtracting all liabilities',
  'Cash':         'Cash and liquid equivalents on hand',
